...
import { EditProduct, GetProductBySlug } from "@/api/useProducts";
...
const UpdateProduct = () => {
  ...
  const { editProduct, isLoading } = EditProduct();
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    const result = await editProduct(product.slug, {
      name: values.name,
      slug: values.slug,
      price: values.price,
            ...
            <header className="items-center justify-between lg:flex">
              <div className="">
                ...
                <p className="mt-1 text-gray-400">
                  Update product based on latest product information
                </p>
              </div>
            ...
            <div className="flex flex-col flex-wrap gap-6 lg:flex-row">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="ex: GZ-ABCD-123" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="space-y-6 lg:flex-[3]">
                <div className="box-shadow flex flex-col gap-6 rounded-md bg-white p-6">
                  <h2 className="text-xl font-medium">Product Image</h2>
                  {pictureUrl ? (
